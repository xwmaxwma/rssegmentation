...
def get_model_complexity_info(model, input_res, print_per_layer_stat=True, as_strings=True, channel=3, flop_units=None, param_units=None):
...
if __name__ == "__main__":
    ...
    net = myTrain(cfg).net
    res_dict = dict(config=args.config)
    res_dict['flops'], res_dict['params'] = get_model_complexity_info(net, args.shape)
    print(res_dict)
    
    json_str = json.dumps(res_dict, indent=0)
